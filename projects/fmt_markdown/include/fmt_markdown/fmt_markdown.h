...
#define FMT_MARKDOWN_MAX_BLOCKS 40000
#define FMT_MARKDOWN_MAX_NESTED_BLOCKS 80000
#define FMT_MARKDOWN_MAX_INLINES 80000
#define FMT_MARKDOWN_MAX_AUX_INLINES 120000
#define FMT_MARKDOWN_MAX_TEXT (4U * 1024U * 1024U)
#define FMT_MARKDOWN_MAX_TABLE_ROWS 12000
#define FMT_MARKDOWN_MAX_TABLE_CELLS 96000
#define FMT_MARKDOWN_MAX_TABLE_CELL_BLOCKS 96000
